...
class indexController {
    async showIndex(req, res, next) {
        try {
            ...
            res.render("common/index", { userId: idUser, top5rated: top5rated, top5newest: top5newest, top5discount: top5discount, top5cheapest: top5cheapest, top5modern: top5modern });
        } catch (error) {
            next(error);
        }
    }
